...
class Packet(object):
    ...
    """
    def __init__(self, time, size, id, src, dst, flow_id=0, portID=None, contentionDelay=0):
        self.time = time
        self.size = size
        self.id = id
        self.src = src
        ...
        self.front =0
        # delay1 used for input buffer latency
        self.delay1 = 0 
        # delay2 used for voq latency
        self.delay2 = 0 
        # delay3 used for contention delay
        self.delay3 = 0 
        self.portID = portID
